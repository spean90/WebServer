...
public class VerifyCodeServlet extends HttpServlet {  
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)  
        ...
        session.setAttribute(ConstantUtil.AUTHCODE, validationCode);  
        // 取得验证码图片并输出   
    ...
    public void init() throws ServletException {  
        ...
        // 随机字符生成器,去除掉容易混淆的字母和数字,如o和0等 1,l,g   
        wordFactory = new RandomWordFactory();  
        wordFactory.setCharacters("abcdefhkmnpqstwxyz23456789ABCDEFGHIJKLMNPQRSTUVWXYZ");  
        ...
        // 验证码图片的大小   
        configurableCaptchaService.setWidth(86);  
