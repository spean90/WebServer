	...
	a.fn.smartWizard = function(k) {
		...
		return this.each(function() {
			...
			function t(d) {
				...
				function() {
				...
				else if (c.transitionEffect == "slideUp") {
					var i = 0;
					d > h ? (nextElmLeft1 = w + 10, nextElmLeft2 = 0, i = 0 - a(a(g, b).attr("href"), b).outerHeight()) : (nextElmLeft1 = 0 - a(a(e, b).attr("href"), b).outerHeight() + 20, nextElmLeft2 = 0, i = 10 + a(a(g, b).attr("href"), b).outerHeight());
					d == h ? (nextElmLeft1 = a(a(e, b).attr("href"), b).outerHeight() + 20, nextElmLeft2 = 0, i = 0 - a(a(g, b).attr("href"), b).outerHeight()) : a(a(g, b).attr("href"), b).animate({
						top: i
					},
					300,
					function() {
					...
					a(a(e, b).attr("href"), b).css("top", nextElmLeft1);
